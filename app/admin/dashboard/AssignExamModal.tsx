                    ...
                    <div className="space-y-3">
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                />
                                <div className="ml-3">
                                    <span className="block text-sm font-medium text-gray-900">Let Candidate Choose Slot</span>
                                    <span className="block text-xs text-gray-500">Candidate picks from available slots in their dashboard.</span>
                                </div>
                            </div>
                        </div>
